...
Os dados são transmitidos por três tipos de mídia:
-Fios de cobre
-Cabos de fibra óptica
-Ondas eletromagnéticas (Sem Fio)

## Como o computador processa tudo:

Toda informação é convertida em - códigos binários - sequências de 0 e 1.
...
È que a internet conecta não só os computadores e celulares, mas também geladeiras, fornos, sistemas de segurança e lâmpadas também podem estar conectadas.
